...
import './View3.css'; // Optional if you have styles
...
const View3 = () => {
  ...
  useEffect(() => {
    fetch('https://mernback-004m.onrender.com/images3')
      .then(res => res.json())
      .then(data => {
  ...
  const handleDelete = async (id) => {
          try {
            const res = await axios.delete(`https://mernback-004m.onrender.com/api/delete3/${id}`);
